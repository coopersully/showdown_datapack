execute if entity @a[tag=developer] run tellraw @a[tag=developer] ["",{"text":"Installation complete. ","color":"green"},{"text":"[+ Gamerules]","color":"blue","clickEvent":{"action":"run_command","value":"/execute in minecraft:overworld run function sd:install-gr"}}]
