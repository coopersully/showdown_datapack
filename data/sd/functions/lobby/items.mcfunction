item replace entity @s hotbar.0 with minecraft:carrot_on_a_stick{statsItem:1b,CustomModelData:6601,display:{Name:'[{"text":"Player Stats","italic":"false","color":"yellow","bold":"true"},{"text":" "}]'}}
item replace entity @s hotbar.4 with minecraft:carrot_on_a_stick{aboutItem:1b,CustomModelData:6602,display:{Name:'[{"text":"About the Game","italic":"false","color":"aqua","bold":"true"},{"text":" "}]'}}
item replace entity @s hotbar.8 with minecraft:carrot_on_a_stick{moneyItem:1b,CustomModelData:6603,display:{Name:'[{"text":"Your Balance","italic":"false","color":"green","bold":"true"},{"text":" "}]'}}
